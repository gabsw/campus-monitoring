...
('tomas_neves', 'Tomas Henriques Neves', 'campus.monitoring.ies+tomasneves@gmail.com', false),
('leandro_coelho', 'Leandro Lopes Coelho', 'campus.monitoring.ies+leandrocoelho@gmail.com', false),
('miguel_vieira', 'Miguel Cunha Vieira', 'campus.monitoring.ies+miguelvieira@gmail.com', false),
('cristina_miranda', 'Cristina Sampaio Miranda', 'campus.monitoring.ies+cristinamiranda@gmail.com', false),
('nuno_gaio', 'Nuno Santos Gaio', 'campus.monitoring.ies+nunogaio@gmail.com', false),
('samuel_rocha', 'Samuel Costa Rocha', 'campus.monitoring.ies+samuelrocha@gmail.com', false),
('eduardo_lima', 'Eduardo Carvalho Lima', 'campus.monitoring.ies+eduardolima@gmail.com', false),
('fernanda_oliveira', 'Fernanda Alves Oliveira', 'campus.monitoring.ies+fernandaoliveira@gmail.com', false),
('marina_ribeiro', 'Marina Goncalves Ribeiro', 'campus.monitoring.ies+marinaribeiro@gmail.com', false),
('vitoria_barbosa', 'Vitoria Pinto Barbosa', 'campus.monitoring.ies+vitoriabarbosa@gmail.com', false),
('laura_melo', 'Laura Sousa Melo', 'campus.monitoring.ies+lauramelo@gmail.com', false),
('bruna_sousa', 'Bruna Pereira Sousa', 'campus.monitoring.ies+brunasousa@gmail.com', false),
('telmo_faria', 'Telmo Leal Faria', 'campus.monitoring.ies+telmofaria@gmail.com', false),
('gabriela_santos', 'Ana Gabriela Loureiro dos Santos', 'gabrielasantos91@ua.pt', true);
